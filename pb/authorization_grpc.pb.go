...
func (UnimplementedAuthorizationServer) Allow(context.Context, *AllowReq) (*AllowResp, error) {
...
func _Authorization_Allow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AllowReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationServer).Allow(ctx, in)
	}
